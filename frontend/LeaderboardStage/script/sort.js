...
export function sortByUID() {
    const container = document.getElementById("users");
    const items = container.querySelectorAll("#user");
    const itemsArray = Array.from(items);

    itemsArray.sort((a, b) => {
        const idA = Number.parseInt(a.querySelector("#Uid").textContent);
        const idB = Number.parseInt(b.querySelector("#Uid").textContent);
...
export function sortByUsername() {
    ...
    itemsArray.sort((a, b) => {
        const idA = a.querySelector("#Username").textContent;
        const idB = b.querySelector("#Username").textContent;
...
export function sortByTotalProblems() {
    const container = document.getElementById("users");
    const items = container.querySelectorAll("#user");
    const itemsArray = Array.from(items);

    itemsArray.sort((a, b) => {
        const idA = Number.parseInt(a.querySelector("#TotalProblems").textContent);
        const idB = Number.parseInt(b.querySelector("#TotalProblems").textContent);
...
export function sortBySuccessRate() {
    const container = document.getElementById("users");
    const items = container.querySelectorAll("#user");
    const itemsArray = Array.from(items);

    itemsArray.sort((a, b) => {
        const idA = Number.parseInt(a.querySelector("#SuccessRate").textContent);
        const idB = Number.parseInt(b.querySelector("#SuccessRate").textContent);
